...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="lg:min-h-[150vh] sm:h-[100vh]  flex flex-col items-center py-0 md:py-10 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-70"
    >
      <motion.h2
        style={{
        ...
        className="sm:text-[2.5rem] lg:text-3xl font-bold mb-20 text-center"
      >
        {title || (
          <span>
